...
void
includeError (char *string, int size, int error_type)
{
  switch (error_type)
  {
  case 0:
    break;			//-- no error
  case 1:
    includeError1 (string, size);
    break;
  case 2:
    includeError2 (string, size);
    break;
  case 3:
    includeError3 (string, size);
    break;
  case 4:
    includeError4 (string, size);
    break;
  default:
    {
...
void
includeError1 (char *string, int size)
{
  int i = 0;
  int exponent = 0;
...
void
includeError3 (char *string, int size)
{
  int index = 0;
  int offset = 0;
...
void
includeError4 (char *string, int size)
{
  int i = 0;
  int offset = 0;
