 ...
 * @section DESCRIPTION
 *
 * Ce fichier contient les descriptions des fonctions utiles pour le vendeur.
 *
 ...
 */
#ifndef __CLIENT_SELLER_H__
#define __CLIENT_SELLER_H__
...
/** Procédure d'envoi des objets à vendre. */
