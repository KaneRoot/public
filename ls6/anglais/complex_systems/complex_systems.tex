...
\fancyhead[C]{Complex systems $\bullet$ October 2012} % Custom header text
...
\title{\vspace{-15mm}\fontsize{24pt}{10pt}\selectfont\textbf{Complex systems}} % Article title
...
A complex system can be defined by an organization composed by a great number of heterogeneous entities and various properties.
